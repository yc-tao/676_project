...
Run: `pytest tests/rq1_dlnm/test_data.py::test_load_env_monthly_joins_three_tables_on_cbsa_year_month -v`
...
Run: `pytest tests/rq1_dlnm/test_data.py -v`
Expected: 1 passed.
...
Run: `pytest tests/rq1_dlnm/test_data.py::test_load_outcomes_filters_chapters_and_returns_counts -v`
...
Run: `pytest tests/rq1_dlnm/test_data.py::test_impute_and_flag_fills_nans_and_reports_fraction -v`
...
Run: `pytest tests/rq1_dlnm/test_data.py::test_prune_exposures_drops_missing_low_variance_and_correlated -v`
...
Run: `pytest tests/rq1_dlnm/test_basis.py -v`
...
Run: `pytest tests/rq1_dlnm/test_basis.py::test_cross_basis_shape_and_linear_sanity -v`
...
Run: `pytest tests/rq1_dlnm/test_model.py -v`
...
Run: `pytest tests/rq1_dlnm/test_model.py::test_fit_recovers_linear_effect_on_synthetic_data -v`
...
Run: `pytest tests/rq1_dlnm/test_model.py::test_observed_information_matches_finite_difference -v`
...
Run: `pytest tests/rq1_dlnm/test_predict.py -v`
...
Run: `pytest tests/rq1_dlnm/test_model.py::test_bh_fdr_basic -v`
